...
internal class MarvelApi(private val client: HttpClient) {
    suspend fun fetchCharacters(queries: FetchCharactersQueries): HttpResponse = client.get("/v1/public/characters") {
        url {
    ...
    suspend fun fetchCharacter(characterId: Int): HttpResponse = client.get("/v1/public/characters/$characterId")

    suspend fun fetchCharacterComics(characterId: String): HttpResponse =
        client.get("/v1/public/characters/$characterId/comics")

    suspend fun fetchComics(queries: FetchComicsQueries): HttpResponse = client.get("/v1/public/comics") {
        url {
    ...
    suspend fun fetchComic(comicId: Int): HttpResponse = client.get("/v1/public/comics/$comicId")
